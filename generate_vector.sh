...
# Sync Scribe Studio API - Documentation Vector Generator
...
for file in $(find . -type f \( -iname "*.md" -o -iname "*.txt" -o -name "*.py" -o -name "Dockerfile" \)
    ...
    echo "File: $file" >> "Sync Scribe Studio API Vector Doc.txt"
    echo -e "\n\n" >> "Sync Scribe Studio API Vector Doc.txt"
    cat "$file" >> "Sync Scribe Studio API Vector Doc.txt"
    echo -e "\n\n" >> "Sync Scribe Studio API Vector Doc.txt"
done